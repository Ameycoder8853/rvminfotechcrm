        ...
        <div className="flex items-center gap-3">
          {(isAdmin || isSenior) && (
            <button
              ...
              className="flex items-center gap-2 px-4 py-2.5 bg-[var(--accent)] hover:bg-[var(--accent-hover)] text-white rounded-xl text-sm font-semibold transition-all active:scale-95 cursor-pointer"
            >
              <UserPlus size={16} />
          ...
          {isAdmin && (
            <button
              ...
              className="flex items-center gap-2 px-4 py-2.5 bg-[var(--surface)] hover:bg-[var(--surface-hover)] border border-[var(--border)] rounded-xl text-sm font-semibold transition-all active:scale-95 cursor-pointer"
            >
              <Plus size={16} />
      ...
      {loading ? (
        ...
        <div className="grid grid-cols-1 xl:grid-cols-3 gap-8">
          ...
          <div className="xl:col-span-2 space-y-6">
            ...
            {teams.length === 0 ? (
              <div className="flex flex-col items-center justify-center p-8 bg-[var(--surface)] border border-[var(--border)] border-dashed rounded-2xl text-center space-y-4 py-12">
                <div className="p-4 bg-[var(--accent-muted)]/15 text-[var(--accent)] rounded-full">
                  <Shield size={32} className="animate-pulse" />
                </div>
                <div className="max-w-xs space-y-1">
                  <h3 className="font-bold text-base text-[var(--foreground)]">No Teams Found</h3>
                ...
                {isAdmin && (
                  <button
                    onClick={() => handleOpenTeamModal()}
                    className="flex items-center gap-2 px-4 py-2 bg-[var(--accent)] hover:bg-[var(--accent-hover)] text-white rounded-xl text-xs font-semibold transition-all active:scale-95 cursor-pointer shadow-md shadow-[var(--accent)]/10"
                  >
                    <Plus size={14} />
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                {teams.map((team) => (
                  <div
                    key={team._id}
                    className="bg-[var(--surface)] border border-[var(--border)] rounded-2xl p-5 space-y-4 hover:border-[var(--border-hover)] transition-all group card-hover"
                  >
          ...
          <div className="bg-[var(--surface)] border border-[var(--border)] rounded-2xl p-5 space-y-6 h-fit">
            ...
            {users.length === 0 ? (
              <div className="flex flex-col items-center justify-center p-8 border border-[var(--border)] border-dashed rounded-xl text-center space-y-4 py-12">
                <div className="p-4 bg-[var(--accent-muted)]/15 text-[var(--accent)] rounded-full">
                  <Users size={32} />
                </div>
                <div className="max-w-xs space-y-1">
                  <h3 className="font-bold text-sm text-[var(--foreground)]">Directory Empty</h3>
        ...
        <form onSubmit={handleUserSubmit} className="space-y-4">
          {isEnrollMode ? (
            <>
              ...
              <div>
                <label className="text-xs font-bold text-[var(--foreground-muted)] uppercase tracking-wider mb-1.5 block">Account Password</label>
                <input
                  required
                  type="password"
          ...
          {isAdmin ? (
            ...
            isEnrollMode && (
              <div className="p-3.5 bg-[var(--accent-muted)]/10 border border-[var(--accent)]/15 rounded-xl">
                <p className="text-xs font-semibold text-[var(--foreground-secondary)] leading-relaxed">
                  💡 Enrolling a new <strong className="text-[var(--accent)]">Junior Representative</strong> under your direct wing. 
